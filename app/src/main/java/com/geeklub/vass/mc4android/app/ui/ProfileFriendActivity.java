...
public class ProfileFriendActivity extends Activity implements OnClickListener{
	...
	protected void onResume() {
		...
		//判断好友是否已经存在黑名单中
		KFIMInterfaces.isBlocked(this, chatName);
		//判断好友是否已经为好友，或者已经发送好友请求
		KFIMInterfaces.isFollowed(this, chatName);
		//获取好友头像本地地址
		KFIMInterfaces.getFriendHeadImage(this, chatName);
				...
				.setPositiveButton("确定",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								if(isBlocked)
								{
									KFIMInterfaces.unblockUser(ProfileFriendActivity.this, chatName);
								}
								else
								{
									KFIMInterfaces.blockUser(ProfileFriendActivity.this, chatName);
								}
				...
				.setPositiveButton("确定",
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								if(isSubscribed)
								{
									KFIMInterfaces.removeFriend(ProfileFriendActivity.this, chatName);
								}
								else
								{
									KFIMInterfaces.addFriend(ProfileFriendActivity.this, chatName, "设置昵称");
								}
